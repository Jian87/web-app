            ...
            <div class="result">
            	<div class="product-story product-story-right product-story-top">
               		<div class="product-story-description">
	                	<div>
	                		<h2>Community</h2>
	                		<p>We strive to ensure that every step in the journey of our products contributes to the well-being of people and the planet.</p>
	                	</div>
                	</div>
                	<div class = "product-story-img"><img src="../images/People1.png" style="">
                	</div>
                </div>

                <div class="product-story product-story-left" style="">
                	<div class = "product-story-img" style=""><img src="../images/People2.jpg" style="">
                	</div>

               		<div class="product-story-description" style="">
	                	<div style="">
	                		<h2>Championing Women</h2>
                ...
                <div class="product-story product-story-right">
                	...
                	<div class="product-story-img" ><img src="../images/People3.jpg">
                	</div>
                </div>


                <div class="product-story product-story-left">
                	<div class="product-story-img"><img src="../images/People4.jpg"></div>
