	...
	<div class = "page-content">
        ...
        <div class = "header">
            <div class="top-menu">
                ...
                <a class="header-btn" href="">my account</button>
                <a class="header-btn" href="chart.php">my chart</button>
            </div>
        </div>
        ...
        <div class="main-content">
        	<div class="personal-container">
             ...
             <div class="personal-info">
                 <button class ="personal-btn get-order-history" id="personal-order-history">Order History</button>
                 <button class ="personal-btn" id="personal-order-chart">Test</button>
                 <button class ="personal-btn get-personal-info" id="get_personal_info">User Info</button>
